...
import { Sparkles, X, Activity, BotMessageSquare, PanelLeft, PanelRight } from "lucide-react";
...
export function AIWorkspace({ 
  ...
  return (
    ...
    >
      {isLeft ? (
        <>
          {/* Toolbar Strip (on the left side) */}
          <div
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  title={dockPosition === "left" ? "Dock Right" : "Dock Left"}
                >
                  {dockPosition === "left" ? <PanelRight size={14} /> : <PanelLeft size={14} />}
                </button>
        ...
        <>
          ...
          {/* Toolbar Strip (on the right side) */}
          <div
            className="flex flex-col items-center"
            style={{
              width: 44,
